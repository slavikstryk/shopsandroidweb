        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">ID-COOLING Frostflow X360</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">2 040</h1>
                ...
                <div className="features-box">
                    ...
                    <div className="features-items">
                        ...
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">1800 об/хв</h1>
                        </div>
                        <div className="features-item">
                        ...
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">394х120х27 мм</h1>
                        </div>
                        <div className="features-item">
