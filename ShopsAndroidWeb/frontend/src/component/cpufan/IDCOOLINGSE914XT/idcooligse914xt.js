...
export default class IDCOOLINGSE914XT extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">ID-COOLING SE-914-XT Basic</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">730</h1>
                ...
                <div className="features-box">
                    ...
                    ID-COOLING SE-914-XT Basic</span></h3>
                    <div className="features-items">
                        ...
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">600-2200 об/хв</h1>
                        </div>
                        <div className="features-item">
                ...
                <BuyWindow product="ID-COOLING SE-914-XT Basic"/>
            </body>
        )
    }
}