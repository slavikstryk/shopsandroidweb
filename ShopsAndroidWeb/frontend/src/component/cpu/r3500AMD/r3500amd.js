...
export default class R3500AMD extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">AMD Ryzen 5 3500 3.2 GHz / 8MB sAM4 BOX</h1>
                </div>
                ...
                <div className="features-box">
                    ...
                    <div className="features-items">
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">Amd Ryzen 5</h1>
                        </div>
                        <div className="features-item">
                        ...
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">7 нм</h1>
                        </div>
                        <div className="features-item">
