        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">Intel Core i9-10900K 3.7 GHz / 20 MB s1200 BOX</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">16 299</h1>
                ...
                <div className="features-box">
                    ...
                    Intel Core i9-10900K 3.7 GHz / 20 MB s1200 BOX</span></h3>
                    <div className="features-items">
                        <div className="features-item">
                            <h3 className="features-text-t">Сімейство процесора</h3>
                            <hr className="hr-features-text" />
                            <h1 className="features-text-t">Intel Core i9</h1>
                        </div>
                        <div className="features-item">
                        ...
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">20</h1>
                        </div>
                        <div className="features-item">
                        ...
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">20 МБ</h1>
                        </div>
                        <div className="features-item">
                ...
                <BuyWindow product="Intel Core i9-10900K 3.7 GHz / 20 MB"/>
            </body>
        )
    }
}