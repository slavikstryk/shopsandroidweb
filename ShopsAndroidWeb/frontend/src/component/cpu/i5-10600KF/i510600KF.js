...
export default class I510600KF extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">Intel Core i5-10600KF 4.1 GHz / 12 MB s1200 BOX</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">6 467</h1>
                ...
                <div className="features-box">
                    ...
                    Intel Core i5-10600KF 4.1 GHz / 12 MB s1200 BOX</span></h3>
                    <div className="features-items">
                        <div className="features-item">
                            <h3 className="features-text-t">Сімейство процесора</h3>
                            <hr className="hr-features-text" />
                            <h1 className="features-text-t">Intel Core i5</h1>
                        </div>
                        <div className="features-item">
                        ...
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">12 МБ</h1>
                        </div>
                        <div className="features-item">
                ...
                <BuyWindow product="Intel Core i5-10600KF 4.1 GHz / 12 MB"/>
            </body>
        )
    }
}