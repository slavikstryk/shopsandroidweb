...
export default class R1600AMD extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">AMD Ryzen 5 1600 3.2 GHz / 8MB sAM4 BOX</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">4 259</h1>
                ...
                <div className="features-box">
                    ...
                    AMD Ryzen 5 1600 3.2 GHz / 16MB sAM4 BOX</span></h3>
                    <div className="features-items">
                        ...
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">Є</h1>
                        </div>
                        <div className="features-item">
                        ...
                        <div className="features-item">
                            ...
                            <hr className="hr-features-text hr10-s" />
                            <h1 className="features-text-t">Zen</h1>
                        </div>
                    </div>
                </div>
                <h2 className="center">Оформити покупку</h2>
                <BuyWindow product="AMD Ryzen 5 1600 3.6-4.2Ghz"/>
            </body>
        )
    }
}