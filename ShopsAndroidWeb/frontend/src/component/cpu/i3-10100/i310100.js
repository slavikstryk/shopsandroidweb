...
export default class I3101000 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">Intel Core i3-10100 3.6GHz / 6MB s1200 BOX</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">3 949</h1>
                ...
                <div className="features-box">
                    ...
                    Intel Core i3-10100 3.6GHz / 6MB s1200 BOX</span></h3>
                    <div className="features-items">
                        <div className="features-item">
                            <h3 className="features-text-t">Сімейство процесора</h3>
                            <hr className="hr-features-text" />
                            <h1 className="features-text-t">Intel Core i3</h1>
                        </div>
                        <div className="features-item">
                            <h3 className="features-text-t">Тип роз'єму</h3>
                            <hr className="hr-features-text hr2_3500" />
                            <h1 className="features-text-t">Socket 1200</h1>
                        </div>
                        <div className="features-item">
                            <h3 className="features-text-t">Кількість ядер</h3>
                            <hr className="hr-features-text hr3_3500" />
                        ...
                        <div className="features-item">
                            ...
                            <hr className="hr-features-text hr5_3500" />
                            <h1 className="features-text-t">14   нм</h1>
                        </div>
                        <div className="features-item">
                            <h3 className="features-text-t">Призначення</h3>
                            <hr className="hr-features-text hr6_3500" />
                            <h1 className="features-text-t">Для комп'ютерів</h1>
                        </div>
                        <div className="features-item">
                            <h3 className="features-text-t">Тип упаковки</h3>
                            <hr className="hr-features-text hr7_3500" />
                            <h1 className="features-text-t">Tray</h1>
                        </div>
                        <div className="features-item">
                            <h3 className="features-text-t">Особливості</h3>
                            <hr className="hr-features-text hr8_3500" />
                            <h1 className="features-text-t">Підтримка Hyper-Threading<br/>
                            Підтримка Turbo Boost<br/>
                            Підтримка Virtualization Technology
                            </h1>
                        </div>
                        <div className="features-item">
                            <h3 className="features-text-t">Обсяг кеш пам'яті 3 уровня</h3>
                            <hr className="hr-features-text hr9_3500" />
                            <h1 className="features-text-t">6 МБ</h1>
                        </div>
                        <div className="features-item">
                            <h3 className="features-text-t">Найменування ядра</h3>
                            <hr className="hr-features-text hr10_3500" />
                            <h1 className="features-text-t">Comet Lake</h1>
                        </div>
                    </div>
                </div>
                <h2 className="center">Оформити покупку</h2>
                <BuyWindow product="Intel Core i3-10100 3.6GHz / 6MB"/>
            </body>
        )
    }
}