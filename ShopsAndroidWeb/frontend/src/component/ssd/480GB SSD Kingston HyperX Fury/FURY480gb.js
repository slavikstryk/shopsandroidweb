...
export default class SSD480GBFURY extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">Kingston SSD HyperX Fury 3D 480GB 2.5" SATAIII TLC</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">1 489</h1>
                ...
                <div className="features-box">
                    ...
                    Kingston SSD HyperX Fury 3D 480GB 2.5" SATAIII TLC</span></h3>
                ...
                <BuyWindow product="SSD Kingston HyperX Fury 480GB"/>
            </body>
        )
    }
}