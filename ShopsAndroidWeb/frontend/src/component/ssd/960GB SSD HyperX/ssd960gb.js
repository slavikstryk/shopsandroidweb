...
export default class SSD960GB extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">Kingston SSD HyperX Fury RGB 960GB 2.5" SATAIII TLC</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">5 500</h1>
                ...
                <div className="features-box">
                    <h3 className="features-text">Характеристики <span className="span-name">Kingston SSD HyperX Fury RGB 960GB 2.5" SATAIII TLC</span></h3>
                    <div className="features-items">
                        <div className="features-item">
                            <h3 className="features-text-t">Обсяг/Об'єм</h3>
                            <hr className="hr-features-text" />
                            <h1 className="features-text-t">960 ГБ</h1>
                        </div>
                        <div className="features-item">
                ...
                <BuyWindow product="SSD Kingston HyperX Fury RGB 960GB" />
            </body>
        )
    }
}