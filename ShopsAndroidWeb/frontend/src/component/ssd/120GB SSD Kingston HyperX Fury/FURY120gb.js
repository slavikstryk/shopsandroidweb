...
export default class SSD120GBFURY extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">Kingston SSD HyperX Fury 3D 120GB 2.5" SATAIII TLC</h1>
                </div>
                ...
                <div className="features-box">
                    ...
                    Kingston SSD HyperX Fury 3D 120GB 2.5" SATAIII TLC</span></h3>
                ...
                <BuyWindow product="SSD Kingston HyperX Fury 120GB"/>
            </body>
        )
    }
}