...
export default class SSD240GBA400 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">Kingston A400 240GB 2.5" SATAIII TLC</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">948</h1>
                ...
                <div className="features-box">
                    <h3 className="features-text">Характеристики <span className="span-name">Kingston A400 240GB 2.5" SATAIII TLC</span></h3>
                    <div className="features-items">
                        ...
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">до 350 МБ/с</h1>
                        </div>
                        <div className="features-item">
                ...
                <BuyWindow product="SSD Kingston A400 240GB"/>
            </body>
        )
    }
}