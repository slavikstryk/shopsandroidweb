...
export default class SSD240GBFURY extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">Kingston SSD HyperX Fury 3D 240GB 2.5" SATAIII TLC</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">949</h1>
                ...
                <div className="features-box">
                    ...
                    Kingston SSD HyperX Fury 3D 240GB 2.5" SATAIII TLC</span></h3>
                    <div className="features-items">
                        ...
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">53 г</h1>
                        </div>
                    </div>
                </div>
                <h2 className="center">Оформити покупку</h2>
                <BuyWindow product="SSD Kingston HyperX Fury 240GB"/>
            </body>
        )
    }
}