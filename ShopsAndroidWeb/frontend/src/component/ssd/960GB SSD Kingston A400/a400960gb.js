...
export default class SSD960GBA400 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">Kingston A400 960GB 2.5" SATAIII TLC</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">2 989</h1>
                ...
                <div className="features-box">
                    ...
                    KingstonA400 960GB 2.5" SATAIII TLC</span></h3>
                ...
                <BuyWindow product="SSD Kingston A400 960GB"/>
            </body>
        )
    }
}