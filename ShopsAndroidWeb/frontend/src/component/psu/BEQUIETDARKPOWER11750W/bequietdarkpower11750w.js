...
export default class BEQUIETDARKPOWER11750W extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">be quiet! Dark Power Pro 11 750W</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">6 402</h1>
                ...
                <BuyWindow product="be quiet! Dark Power Pro 11 750W" />
            </body>
        )
    }
}