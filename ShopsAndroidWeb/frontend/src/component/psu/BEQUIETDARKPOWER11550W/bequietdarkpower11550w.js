...
export default class BEQUIETDARKPOWER11550W extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">be quiet! Dark Power Pro 11 550W</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">4 399</h1>
                ...
                <div className="features-box">
                    ...
                    <div className="features-items">
                        ...
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">8</h1>
                        </div>
                        <div className="features-item">
                ...
                <BuyWindow product="be quiet! Dark Power Pro 11 550W" />
            </body>
        )
    }
}