...
export default class GAMEMAX600W extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
    ...
    render() {
        return (
            <body className="bg">
                ...
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">1 676</h1>
                ...
                <BuyWindow product="GameMax GM-600 600W" />
            </body>
        )
    }
}