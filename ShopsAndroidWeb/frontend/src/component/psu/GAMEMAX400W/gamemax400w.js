...
export default class GAMEMAX400W extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
    ...
    render() {
        return (
            <body className="bg">
                ...
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">476</h1>
                ...
                <div className="features-box">
                    ...
                    <div className="features-items">
                        ...
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">80 мм</h1>
                        </div>
                        <div className="features-item">
                ...
                <BuyWindow product="GameMax GM-400-8CM 400W" />
            </body>
        )
    }
}