...
export default class BEQUIETDARKPOWER111200W extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">be quiet! Dark Power Pro 11 1200W</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">8 399</h1>
                ...
                <div className="features-box">
                    ...
                    be quiet! Dark Power Pro 11 1200W</span></h3>
                    <div className="features-items">
                        <div className="features-item">
                            <h3 className="features-text-t">Потужність</h3>
                            <hr className="hr-features-text" />
                            <h1 className="features-text-t">1200 Вт</h1>
                        </div>
                        <div className="features-item">
                            <h3 className="features-text-t">Тип</h3>
                            <hr className="hr-features-text hr2_psu" />
                            <h1 className="features-text-t">Комп'ютерний</h1>
                        </div>
                        <div className="features-item">
                            <h3 className="features-text-t">Охолодження</h3>
                            <hr className="hr-features-text hr3_psu" />
                            <h1 className="features-text-t">Вентилятор</h1>
                        </div>
                        <div className="features-item">
                            <h3 className="features-text-t">Кількість SATA роз'ємів</h3>
                            <hr className="hr-features-text hr4_psu" />
                            <h1 className="features-text-t">10</h1>
                        </div>
                        <div className="features-item">
                            <h3 className="features-text-t">Максимальні навантаження</h3>
                            <hr className="hr-features-text hr5_psu" />
                            <h1 className="features-text-t">1200 Вт</h1>
                        </div>
                        <div className="features-item">
                            <h3 className="features-text-t">Діаметр вентилятора</h3>
                            <hr className="hr-features-text hr6_psu" />
                            <h1 className="features-text-t">135 мм</h1>
                        </div>
                        <div className="features-item">
                            <h3 className="features-text-t">Тип системи охолодження</h3>
                            <hr className="hr-features-text hr7_psu" />
                            <h1 className="features-text-t">Активна</h1>
                        </div>
                        <div className="features-item">
                            <h3 className="features-text-t">Функція PFC</h3>
                            <hr className="hr-features-text hr8_psu" />
                            <h1 className="features-text-t">Активний</h1>
                        </div>
                    </div>
                </div>
                <h2 className="center">Оформити покупку</h2>
                <BuyWindow product="be quiet! Dark Power Pro 11 1200W" />
            </body>
        )
    }
}