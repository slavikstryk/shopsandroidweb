...
export default class GTX1030 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">ASUS GeForce GT1030 2048Mb OC</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">4 779</h1>
                ...
                <BuyWindow product="ASUS GeForce GT1030 2048Mb OC" />
            </body>
        )
    }
}