...
export default class AMDRX5804GB extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">Sapphire RX 580 Nitro+ (4Gb/GDDR5/256bit)</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">12 000</h1>
                ...
                <div className="features-box">
                    ...
                    Sapphire RX 580 Nitro+ (4Gb/GDDR5/256bit)</span></h3>
                    <div className="features-items">
                        ...
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">1411 МГц</h1>
                        </div>
                        <div className="features-item">
                ...
                <BuyWindow product="Sapphire RX 580 Nitro+ (4Gb/GDDR5/256bit)" />
            </body>
        )
    }
}