...
export default class AMDRX5708GB extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">Sapphire Radeon RX 570 8192Mb NITRO+</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">6 684</h1>
                ...
                <div className="features-box">
                    ...
                    Sapphire Radeon RX 570 8192Mb NITRO+</span></h3>
                    <div className="features-items">
                        ...
                        <div className="features-item">
                            ...
                            <h1 className="features-text-t">8+6 pin</h1>
                        </div>
                    </div>
                </div>
                <h2 className="center">Оформити покупку</h2>
                <BuyWindow product="Sapphire Radeon RX 570 8192Mb NITRO+" />
            </body>
        )
    }
}