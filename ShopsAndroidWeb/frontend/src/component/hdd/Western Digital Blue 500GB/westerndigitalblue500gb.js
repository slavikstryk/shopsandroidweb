        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">Western Digital Blue 500GB 5400rpm</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">1 000</h1>
                ...
                <BuyWindow product="Western Digital Blue 500GB 5400rpm"/>
            </body>
        )
    }
}