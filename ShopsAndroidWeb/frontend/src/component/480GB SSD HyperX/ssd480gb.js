...
export default class SSD480GB extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">Kingston SSD HyperX Fury RGB 480GB 2.5" SATAIII TLC</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">2 900</h1>
                ...
                <div className="features-box">
                    <h3 className="features-text">Характеристики <span className="span-name">Kingston SSD HyperX Fury RGB 480GB 2.5" SATAIII TLC</span></h3>
                ...
                <BuyWindow product="SSD Kingston HyperX Fury RGB 480GB"/>
            </body>
        )
    }
}