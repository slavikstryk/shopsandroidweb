...
export default class RAM4X8GB3200FURYRGB extends Component {
    constructor(props) {
        super(props);
        this.state = {
            src: photo1
        ...
        return (
            <body className="bg">
                <div className="top-text-box">
                    <h1 className="normal-text">Kingston Fury DDR4-3200 4x8192 MB</h1>
                </div>
                <div className="work-window">
                    ...
                    <div className="buy-set">
                        <div className="price-set">
                            <h1 className="normal-text price">5 279</h1>
                ...
                <div className="features-box">
                    ...
                    Kingston Fury RGB DDR4-3200 4x8192 MB</span></h3>
                    <div className="features-items">
                        <div className="features-item">
                            <h3 className="features-text-t">Обсяг/Об'єм</h3>
                            <hr className="hr-features-text" />
                            <h1 className="features-text-t">4x8 ГБ</h1>
                        </div>
                        <div className="features-item">
                ...
                <BuyWindow product="RAM Kingston HyperX RGB 4x8GB 3200"/>
            </body>
        )
    }
}